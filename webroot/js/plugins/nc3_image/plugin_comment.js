...
tinymce.PluginManager.add('nc3Image', function(editor) {
  ...
  function showDialog(imageList) {
    ...
    function srcChange(e) {
      ...
      if (!meta.width && !meta.height) {
        ...
        // Pattern test the src url and make sure we haven't already
        // prepended the url
    ...
    if (imageList) {
      imageListCtrl = {
        ...
        onselect: function(e) {
          ...
          if (!altCtrl.value() || (e.lastControl &&
  ...
  editor.on('preInit', function() {
    ...
    editor.serializer.addNodeFilter(
        'figure', toggleContentEditableState(false));
  });
  ...
  editor.addButton('nc3Image', {
    ...
    stateSelector: 'img:not([data-mce-object],' +
        '[data-mce-placeholder]),figure.image'
  });

  editor.addMenuItem('nc3Image', {
    icon: 'image',
